...
if [ ! -e usr ]
then
	for PKG in python3-psycopg2 python3-psutil libffi6 python3-pip python3-distutils python3-venv python-pip-whl python3.7 libpython3.7-stdlib python3.7-minimal python3.7-venv libpython3.7-minimal # python3-minimal libpython3-stdlib python3-venv
	do
...
[ ! -e get-pip.py ] && wget https://bootstrap.pypa.io/pip/3.7/get-pip.py && python 3.7 ./usr/bin/get-pip.py
...
pip3 install -r odoo-$ODOO/requirements.txt
